...
| retry-limit  | number | The number of times to attempt to upload files if a call fails. (Default: 3) |
| retry-interval  | number | The number of seconds to wait between upload attempts. (Default: 3) |
